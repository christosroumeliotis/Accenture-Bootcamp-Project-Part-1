...
import org.example.utilities.RandomGenerators;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Insured ins1 = new Insured(String.valueOf(123123), String.valueOf(333333), "Giannis", "10/10/1999", "Mihailidis", "email@email.com");
        ...
        ArrayList<Insured> insureds = RandomGenerators.createInsureds();
        insureds.forEach(Insured::printInfoForInsured);
    }
}