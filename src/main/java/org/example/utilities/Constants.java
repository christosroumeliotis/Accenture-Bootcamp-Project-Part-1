...
public class Constants {
    public static final int NUMBER_OF_INSUREDS = 15;
    public static final int NUMBER_OF_VACCINATION_CENTERS = 2;
    public static final int NUMBER_OF_DOCTORS = 4;
    ...
    public static final String[] VACCINATION_CENTER_CODE = {"THESS01", "THESS02", "ATH01", "ATH02"};
    public static final String[] VACCINATION_CENTER_ADDRESS = {"Tsimiski 1", "EGNATIA 1", "Ermou 1", "Stadiou 1"};
}
